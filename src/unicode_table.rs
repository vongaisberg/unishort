...
//
//   ucd-generate property-bool . --chars
//
...
pub const ALPHABETIC: &'static [(char, char)] = &[
  ...
  ('ও', 'ন'), ('প', 'র'), ('ল', 'ল'), ('শ', 'হ'),
  ('ঽ', '\u{9c4}'), ('ে', 'ৈ'), ('ো', 'ৌ'), ('ৎ', 'ৎ'),
  ('\u{9d7}', '\u{9d7}'), ('ড়', 'ঢ়'), ('য়', '\u{9e3}'), ('ৰ', 'ৱ'),
  ('ৼ', 'ৼ'), ('\u{a01}', 'ਃ'), ('ਅ', 'ਊ'), ('ਏ', 'ਐ'),
  ('ਓ', 'ਨ'), ('ਪ', 'ਰ'), ('ਲ', 'ਲ਼'), ('ਵ', 'ਸ਼'),
  ('ਸ', 'ਹ'), ('ਾ', '\u{a42}'), ('\u{a47}', '\u{a48}'),
  ('\u{a4b}', '\u{a4c}'), ('\u{a51}', '\u{a51}'), ('ਖ਼', 'ੜ'),
  ('ਫ਼', 'ਫ਼'), ('\u{a70}', '\u{a75}'), ('\u{a81}', 'ઃ'), ('અ', 'ઍ'),
  ('એ', 'ઑ'), ('ઓ', 'ન'), ('પ', 'ર'), ('લ', 'ળ'),
  ('વ', 'હ'), ('ઽ', '\u{ac5}'), ('\u{ac7}', 'ૉ'), ('ો', 'ૌ'),
  ('ૐ', 'ૐ'), ('ૠ', '\u{ae3}'), ('ૹ', '\u{afc}'), ('\u{b01}', 'ଃ'),
  ('ଅ', 'ଌ'), ('ଏ', 'ଐ'), ('ଓ', 'ନ'), ('ପ', 'ର'),
  ('ଲ', 'ଳ'), ('ଵ', 'ହ'), ('ଽ', '\u{b44}'), ('େ', 'ୈ'),
  ('ୋ', 'ୌ'), ('\u{b56}', '\u{b57}'), ('ଡ଼', 'ଢ଼'), ('ୟ', '\u{b63}'),
  ('ୱ', 'ୱ'), ('\u{b82}', 'ஃ'), ('அ', 'ஊ'), ('எ', 'ஐ'),
  ('ஒ', 'க'), ('ங', 'ச'), ('ஜ', 'ஜ'), ('ஞ', 'ட'),
  ('ண', 'த'), ('ந', 'ப'), ('ம', 'ஹ'), ('\u{bbe}', 'ூ'),
  ...
  ('ೞ', 'ೞ'), ('ೠ', '\u{ce3}'), ('ೱ', 'ೲ'), ('\u{d00}', 'ഌ'),
  ('എ', 'ഐ'), ('ഒ', 'ഺ'), ('ഽ', '\u{d44}'), ('െ', 'ൈ'),
  ('ൊ', 'ൌ'), ('ൎ', 'ൎ'), ('ൔ', '\u{d57}'), ('ൟ', '\u{d63}'),
  ('ൺ', 'ൿ'), ('\u{d81}', 'ඃ'), ('අ', 'ඖ'), ('ක', 'න'),
  ('ඳ', 'ර'), ('ල', 'ල'), ('ව', 'ෆ'), ('\u{dcf}', '\u{dd4}'),
  ('\u{dd6}', '\u{dd6}'), ('ෘ', '\u{ddf}'), ('ෲ', 'ෳ'),
  ('ก', '\u{e3a}'), ('เ', 'ๆ'), ('\u{e4d}', '\u{e4d}'), ('ກ', 'ຂ'),
  ('ຄ', 'ຄ'), ('ຆ', 'ຊ'), ('ຌ', 'ຣ'), ('ລ', 'ລ'),
  ('ວ', '\u{eb9}'), ('\u{ebb}', 'ຽ'), ('ເ', 'ໄ'), ('ໆ', 'ໆ'),
  ('\u{ecd}', '\u{ecd}'), ('ໜ', 'ໟ'), ('ༀ', 'ༀ'), ('ཀ', 'ཇ'),
  ('ཉ', 'ཬ'), ('\u{f71}', '\u{f81}'), ('ྈ', '\u{f97}'),
  ...
  ('\u{1abf}', '\u{1ac0}'), ('\u{1b00}', 'ᬳ'), ('\u{1b35}', 'ᭃ'),
  ('ᭅ', 'ᭋ'), ('\u{1b80}', '\u{1ba9}'), ('\u{1bac}', 'ᮯ'),
  ('ᮺ', 'ᯥ'), ('ᯧ', '\u{1bf1}'), ('ᰀ', '\u{1c36}'), ('ᱍ', 'ᱏ'),
  ('ᱚ', 'ᱽ'), ('ᲀ', 'ᲈ'), ('Ა', 'Ჺ'), ('Ჽ', 'Ჿ'),
  ('ᳩ', 'ᳬ'), ('ᳮ', 'ᳳ'), ('ᳵ', 'ᳶ'), ('ᳺ', 'ᳺ'),
  ('ᴀ', 'ᶿ'), ('\u{1de7}', '\u{1df4}'), ('Ḁ', 'ἕ'), ('Ἐ', 'Ἕ'),
  ('ἠ', 'ὅ'), ('Ὀ', 'Ὅ'), ('ὐ', 'ὗ'), ('Ὑ', 'Ὑ'),
  ('Ὓ', 'Ὓ'), ('Ὕ', 'Ὕ'), ('Ὗ', 'ώ'), ('ᾀ', 'ᾴ'),
  ('ᾶ', 'ᾼ'), ('ι', 'ι'), ('ῂ', 'ῄ'), ('ῆ', 'ῌ'),
  ('ῐ', 'ΐ'), ('ῖ', 'Ί'), ('ῠ', 'Ῥ'), ('ῲ', 'ῴ'),
  ...
  ('ⵯ', 'ⵯ'), ('ⶀ', 'ⶖ'), ('ⶠ', 'ⶦ'), ('ⶨ', 'ⶮ'),
  ('ⶰ', 'ⶶ'), ('ⶸ', 'ⶾ'), ('ⷀ', 'ⷆ'), ('ⷈ', 'ⷎ'),
  ('ⷐ', 'ⷖ'), ('ⷘ', 'ⷞ'), ('\u{2de0}', '\u{2dff}'), ('ⸯ', 'ⸯ'),
  ('々', '〇'), ('〡', '〩'), ('〱', '〵'), ('〸', '〼'),
  ('ぁ', 'ゖ'), ('ゝ', 'ゟ'), ('ァ', 'ヺ'), ('ー', 'ヿ'),
  ('ㄅ', 'ㄯ'), ('ㄱ', 'ㆎ'), ('ㆠ', 'ㆿ'), ('ㇰ', 'ㇿ'),
  ('㐀', '䶿'), ('一', '鿼'), ('ꀀ', 'ꒌ'), ('ꓐ', 'ꓽ'),
  ('ꔀ', 'ꘌ'), ('ꘐ', 'ꘟ'), ('ꘪ', 'ꘫ'), ('Ꙁ', 'ꙮ'),
  ('\u{a674}', '\u{a67b}'), ('ꙿ', 'ꛯ'), ('ꜗ', 'ꜟ'), ('Ꜣ', 'ꞈ'),
  ('Ꞌ', 'ꞿ'), ('Ꟃ', 'ꟊ'), ('Ꟶ', 'ꠅ'), ('ꠇ', 'ꠧ'),
  ('ꡀ', 'ꡳ'), ('ꢀ', 'ꣃ'), ('\u{a8c5}', '\u{a8c5}'), ('ꣲ', 'ꣷ'),
  ('ꣻ', 'ꣻ'), ('ꣽ', '\u{a8ff}'), ('ꤊ', '\u{a92a}'), ('ꤰ', 'ꥒ'),
  ('ꥠ', 'ꥼ'), ('\u{a980}', 'ꦲ'), ('ꦴ', 'ꦿ'), ('ꧏ', 'ꧏ'),
  ('ꧠ', 'ꧯ'), ('ꧺ', 'ꧾ'), ('ꨀ', '\u{aa36}'), ('ꩀ', 'ꩍ'),
  ('ꩠ', 'ꩶ'), ('ꩺ', '\u{aabe}'), ('ꫀ', 'ꫀ'), ('ꫂ', 'ꫂ'),
  ('ꫛ', 'ꫝ'), ('ꫠ', 'ꫯ'), ('ꫲ', 'ꫵ'), ('ꬁ', 'ꬆ'),
  ('ꬉ', 'ꬎ'), ('ꬑ', 'ꬖ'), ('ꬠ', 'ꬦ'), ('ꬨ', 'ꬮ'),
  ('ꬰ', 'ꭚ'), ('ꭜ', 'ꭩ'), ('ꭰ', 'ꯪ'), ('가', '힣'),
  ('ힰ', 'ퟆ'), ('ퟋ', 'ퟻ'), ('豈', '舘'), ('並', '龎'),
  ...
  ('𐠿', '𐡕'), ('𐡠', '𐡶'), ('𐢀', '𐢞'), ('𐣠', '𐣲'),
  ('𐣴', '𐣵'), ('𐤀', '𐤕'), ('𐤠', '𐤹'), ('𐦀', '𐦷'),
  ('𐦾', '𐦿'), ('𐨀', '\u{10a03}'), ('\u{10a05}', '\u{10a06}'),
  ('\u{10a0c}', '𐨓'), ('𐨕', '𐨗'), ('𐨙', '𐨵'), ('𐩠', '𐩼'),
  ('𐪀', '𐪜'), ('𐫀', '𐫇'), ('𐫉', '𐫤'), ('𐬀', '𐬵'),
  ('𐭀', '𐭕'), ('𐭠', '𐭲'), ('𐮀', '𐮑'), ('𐰀', '𐱈'),
  ('𐲀', '𐲲'), ('𐳀', '𐳲'), ('𐴀', '\u{10d27}'), ('𐺀', '𐺩'),
  ('\u{10eab}', '\u{10eac}'), ('𐺰', '𐺱'), ('𐼀', '𐼜'),
  ('𐼧', '𐼧'), ('𐼰', '𐽅'), ('𐾰', '𐿄'), ('𐿠', '𐿶'),
  ('𑀀', '\u{11045}'), ('𑂂', '𑂸'), ('𑃐', '𑃨'),
  ('\u{11100}', '\u{11132}'), ('𑅄', '𑅇'), ('𑅐', '𑅲'),
  ('𑅶', '𑅶'), ('\u{11180}', '𑆿'), ('𑇁', '𑇄'),
  ('𑇎', '\u{111cf}'), ('𑇚', '𑇚'), ('𑇜', '𑇜'), ('𑈀', '𑈑'),
  ...
  ('\u{11443}', '𑑅'), ('𑑇', '𑑊'), ('𑑟', '𑑡'), ('𑒀', '𑓁'),
  ('𑓄', '𑓅'), ('𑓇', '𑓇'), ('𑖀', '\u{115b5}'), ('𑖸', '𑖾'),
  ('𑗘', '\u{115dd}'), ('𑘀', '𑘾'), ('\u{11640}', '\u{11640}'),
  ('𑙄', '𑙄'), ('𑚀', '\u{116b5}'), ('𑚸', '𑚸'), ('𑜀', '𑜚'),
  ('\u{1171d}', '\u{1172a}'), ('𑠀', '𑠸'), ('𑢠', '𑣟'),
  ('𑣿', '𑤆'), ('𑤉', '𑤉'), ('𑤌', '𑤓'), ('𑤕', '𑤖'),
  ('𑤘', '𑤵'), ('𑤷', '𑤸'), ('\u{1193b}', '\u{1193c}'),
  ('𑤿', '𑥂'), ('𑦠', '𑦧'), ('𑦪', '\u{119d7}'),
  ('\u{119da}', '𑧟'), ('𑧡', '𑧡'), ('𑧣', '𑧤'), ('𑨀', '𑨲'),
  ('\u{11a35}', '\u{11a3e}'), ('𑩐', '𑪗'), ('𑪝', '𑪝'),
  ('𑫀', '𑫸'), ('𑰀', '𑰈'), ('𑰊', '\u{11c36}'),
  ('\u{11c38}', '𑰾'), ('𑱀', '𑱀'), ('𑱲', '𑲏'),
  ('\u{11c92}', '\u{11ca7}'), ('𑲩', '\u{11cb6}'), ('𑴀', '𑴆'),
  ('𑴈', '𑴉'), ('𑴋', '\u{11d36}'), ('\u{11d3a}', '\u{11d3a}'),
  ('\u{11d3c}', '\u{11d3d}'), ('\u{11d3f}', '\u{11d41}'),
  ('\u{11d43}', '\u{11d43}'), ('𑵆', '\u{11d47}'), ('𑵠', '𑵥'),
  ('𑵧', '𑵨'), ('𑵪', '𑶎'), ('\u{11d90}', '\u{11d91}'),
  ('𑶓', '𑶖'), ('𑶘', '𑶘'), ('𑻠', '𑻶'), ('𑾰', '𑾰'),
  ('𒀀', '𒎙'), ('𒐀', '𒑮'), ('𒒀', '𒕃'), ('𓀀', '𓐮'),
  ('𔐀', '𔙆'), ('𖠀', '𖨸'), ('𖩀', '𖩞'), ('𖫐', '𖫭'),
  ('𖬀', '𖬯'), ('𖭀', '𖭃'), ('𖭣', '𖭷'), ('𖭽', '𖮏'),
  ('𖹀', '𖹿'), ('𖼀', '𖽊'), ('\u{16f4f}', '𖾇'),
  ('\u{16f8f}', '𖾟'), ('𖿠', '𖿡'), ('𖿣', '𖿣'), ('𖿰', '𖿱'),
  ('𗀀', '𘟷'), ('𘠀', '𘳕'), ('𘴀', '𘴈'), ('𛀀', '𛄞'),
  ('𛅐', '𛅒'), ('𛅤', '𛅧'), ('𛅰', '𛋻'), ('𛰀', '𛱪'),
  ('𛱰', '𛱼'), ('𛲀', '𛲈'), ('𛲐', '𛲙'),
  ('\u{1bc9e}', '\u{1bc9e}'), ('𝐀', '𝑔'), ('𝑖', '𝒜'),
  ('𝒞', '𝒟'), ('𝒢', '𝒢'), ('𝒥', '𝒦'), ('𝒩', '𝒬'),
  ('𝒮', '𝒹'), ('𝒻', '𝒻'), ('𝒽', '𝓃'), ('𝓅', '𝔅'),
  ('𝔇', '𝔊'), ('𝔍', '𝔔'), ('𝔖', '𝔜'), ('𝔞', '𝔹'),
  ('𝔻', '𝔾'), ('𝕀', '𝕄'), ('𝕆', '𝕆'), ('𝕊', '𝕐'),
  ...
  ('\u{1e026}', '\u{1e02a}'), ('𞄀', '𞄬'), ('𞄷', '𞄽'),
  ('𞅎', '𞅎'), ('𞋀', '𞋫'), ('𞠀', '𞣄'), ('𞤀', '𞥃'),
  ('\u{1e947}', '\u{1e947}'), ('𞥋', '𞥋'), ('𞸀', '𞸃'),
  ('𞸅', '𞸟'), ('𞸡', '𞸢'), ('𞸤', '𞸤'), ('𞸧', '𞸧'),
  ('𞸩', '𞸲'), ('𞸴', '𞸷'), ('𞸹', '𞸹'), ('𞸻', '𞸻'),
  ('𞹂', '𞹂'), ('𞹇', '𞹇'), ('𞹉', '𞹉'), ('𞹋', '𞹋'),
  ('𞹍', '𞹏'), ('𞹑', '𞹒'), ('𞹔', '𞹔'), ('𞹗', '𞹗'),
...
pub const CASE_IGNORABLE: &'static [(char, char)] = &[
  ...
  ('\u{b55}', '\u{b56}'), ('\u{b62}', '\u{b63}'), ('\u{b82}', '\u{b82}'),
  ...
  ('\u{d4d}', '\u{d4d}'), ('\u{d62}', '\u{d63}'), ('\u{d81}', '\u{d81}'),
  ('\u{dca}', '\u{dca}'), ('\u{dd2}', '\u{dd4}'), ('\u{dd6}', '\u{dd6}'),
  ('\u{e31}', '\u{e31}'), ('\u{e34}', '\u{e3a}'), ('ๆ', '\u{e4e}'),
  ('\u{eb1}', '\u{eb1}'), ('\u{eb4}', '\u{ebc}'), ('ໆ', 'ໆ'),
  ...
  ('\u{1a73}', '\u{1a7c}'), ('\u{1a7f}', '\u{1a7f}'), ('ᪧ', 'ᪧ'),
  ('\u{1ab0}', '\u{1ac0}'), ('\u{1b00}', '\u{1b03}'),
  ('\u{1b34}', '\u{1b34}'), ('\u{1b36}', '\u{1b3a}'),
  ('\u{1b3c}', '\u{1b3c}'), ('\u{1b42}', '\u{1b42}'),
  ('\u{1b6b}', '\u{1b73}'), ('\u{1b80}', '\u{1b81}'),
  ('\u{1ba2}', '\u{1ba5}'), ('\u{1ba8}', '\u{1ba9}'),
  ('\u{1bab}', '\u{1bad}'), ('\u{1be6}', '\u{1be6}'),
  ('\u{1be8}', '\u{1be9}'), ('\u{1bed}', '\u{1bed}'),
  ('\u{1bef}', '\u{1bf1}'), ('\u{1c2c}', '\u{1c33}'),
  ('\u{1c36}', '\u{1c37}'), ('ᱸ', 'ᱽ'), ('\u{1cd0}', '\u{1cd2}'),
  ('\u{1cd4}', '\u{1ce0}'), ('\u{1ce2}', '\u{1ce8}'),
  ('\u{1ced}', '\u{1ced}'), ('\u{1cf4}', '\u{1cf4}'),
  ('\u{1cf8}', '\u{1cf9}'), ('ᴬ', 'ᵪ'), ('ᵸ', 'ᵸ'),
  ('ᶛ', '\u{1df9}'), ('\u{1dfb}', '\u{1dff}'), ('᾽', '᾽'),
  ('᾿', '῁'), ('῍', '῏'), ('῝', '῟'), ('῭', '`'),
  ('´', '῾'), ('\u{200b}', '\u{200f}'), ('‘', '’'), ('․', '․'),
  ('‧', '‧'), ('\u{202a}', '\u{202e}'), ('\u{2060}', '\u{2064}'),
  ('\u{2066}', '\u{206f}'), ('ⁱ', 'ⁱ'), ('ⁿ', 'ⁿ'), ('ₐ', 'ₜ'),
  ('\u{20d0}', '\u{20f0}'), ('ⱼ', 'ⱽ'), ('\u{2cef}', '\u{2cf1}'),
  ('ⵯ', 'ⵯ'), ('\u{2d7f}', '\u{2d7f}'), ('\u{2de0}', '\u{2dff}'),
  ('ⸯ', 'ⸯ'), ('々', '々'), ('\u{302a}', '\u{302d}'), ('〱', '〵'),
  ('〻', '〻'), ('\u{3099}', 'ゞ'), ('ー', 'ヾ'), ('ꀕ', 'ꀕ'),
  ('ꓸ', 'ꓽ'), ('ꘌ', 'ꘌ'), ('\u{a66f}', '\u{a672}'),
  ('\u{a674}', '\u{a67d}'), ('ꙿ', 'ꙿ'), ('ꚜ', '\u{a69f}'),
  ('\u{a6f0}', '\u{a6f1}'), ('꜀', '꜡'), ('ꝰ', 'ꝰ'), ('ꞈ', '꞊'),
  ('ꟸ', 'ꟹ'), ('\u{a802}', '\u{a802}'), ('\u{a806}', '\u{a806}'),
  ('\u{a80b}', '\u{a80b}'), ('\u{a825}', '\u{a826}'),
  ('\u{a82c}', '\u{a82c}'), ('\u{a8c4}', '\u{a8c5}'),
  ('\u{a8e0}', '\u{a8f1}'), ('\u{a8ff}', '\u{a8ff}'),
  ('\u{a926}', '\u{a92d}'), ('\u{a947}', '\u{a951}'),
  ('\u{a980}', '\u{a982}'), ('\u{a9b3}', '\u{a9b3}'),
  ('\u{a9b6}', '\u{a9b9}'), ('\u{a9bc}', '\u{a9bd}'), ('ꧏ', 'ꧏ'),
  ('\u{a9e5}', 'ꧦ'), ('\u{aa29}', '\u{aa2e}'), ('\u{aa31}', '\u{aa32}'),
  ('\u{aa35}', '\u{aa36}'), ('\u{aa43}', '\u{aa43}'),
  ('\u{aa4c}', '\u{aa4c}'), ('ꩰ', 'ꩰ'), ('\u{aa7c}', '\u{aa7c}'),
  ('\u{aab0}', '\u{aab0}'), ('\u{aab2}', '\u{aab4}'),
  ('\u{aab7}', '\u{aab8}'), ('\u{aabe}', '\u{aabf}'),
  ('\u{aac1}', '\u{aac1}'), ('ꫝ', 'ꫝ'), ('\u{aaec}', '\u{aaed}'),
  ('ꫳ', 'ꫴ'), ('\u{aaf6}', '\u{aaf6}'), ('꭛', 'ꭟ'), ('ꭩ', '꭫'),
  ...
  ('\u{10d24}', '\u{10d27}'), ('\u{10eab}', '\u{10eac}'),
  ...
  ('\u{111c9}', '\u{111cc}'), ('\u{111cf}', '\u{111cf}'),
  ...
  ('\u{11839}', '\u{1183a}'), ('\u{1193b}', '\u{1193c}'),
  ('\u{1193e}', '\u{1193e}'), ('\u{11943}', '\u{11943}'),
  ...
  ('\u{11ef3}', '\u{11ef4}'), ('\u{13430}', '\u{13438}'),
  ('\u{16af0}', '\u{16af4}'), ('\u{16b30}', '\u{16b36}'), ('𖭀', '𖭃'),
  ('\u{16f4f}', '\u{16f4f}'), ('\u{16f8f}', '𖾟'), ('𖿠', '𖿡'),
  ('𖿣', '\u{16fe4}'), ('\u{1bc9d}', '\u{1bc9e}'),
  ('\u{1bca0}', '\u{1bca3}'), ('\u{1d167}', '\u{1d169}'),
  ('\u{1d173}', '\u{1d182}'), ('\u{1d185}', '\u{1d18b}'),
  ...
  ('\u{1e000}', '\u{1e006}'), ('\u{1e008}', '\u{1e018}'),
  ('\u{1e01b}', '\u{1e021}'), ('\u{1e023}', '\u{1e024}'),
  ('\u{1e026}', '\u{1e02a}'), ('\u{1e130}', '𞄽'),
  ('\u{1e2ec}', '\u{1e2ef}'), ('\u{1e8d0}', '\u{1e8d6}'),
  ('\u{1e944}', '𞥋'), ('🏻', '🏿'), ('\u{e0001}', '\u{e0001}'),
...
pub const DIACRITIC: &'static [(char, char)] = &[
  ...
  ('\u{b55}', '\u{b55}'), ('\u{bcd}', '\u{bcd}'), ('\u{c4d}', '\u{c4d}'),
  ('\u{cbc}', '\u{cbc}'), ('\u{ccd}', '\u{ccd}'), ('\u{d3b}', '\u{d3c}'),
  ('\u{d4d}', '\u{d4d}'), ('\u{dca}', '\u{dca}'), ('\u{e47}', '\u{e4c}'),
  ('\u{e4e}', '\u{e4e}'), ('\u{eba}', '\u{eba}'), ('\u{ec8}', '\u{ecc}'),
  ('\u{f18}', '\u{f19}'), ('\u{f35}', '\u{f35}'), ('\u{f37}', '\u{f37}'),
  ('\u{f39}', '\u{f39}'), ('༾', '༿'), ('\u{f82}', '\u{f84}'),
  ('\u{f86}', '\u{f87}'), ('\u{fc6}', '\u{fc6}'), ('\u{1037}', '\u{1037}'),
  ('\u{1039}', '\u{103a}'), ('ၣ', 'ၤ'), ('ၩ', 'ၭ'),
  ('ႇ', '\u{108d}'), ('ႏ', 'ႏ'), ('ႚ', 'ႛ'),
  ('\u{135d}', '\u{135f}'), ('\u{17c9}', '\u{17d3}'),
  ...
  ('꭛', 'ꭟ'), ('ꭩ', '꭫'), ('꯬', '\u{abed}'),
  ('\u{fb1e}', '\u{fb1e}'), ('\u{fe20}', '\u{fe2f}'), ('＾', '＾'),
  ('｀', '｀'), ('ｰ', 'ｰ'), ('\u{ff9e}', '\u{ff9f}'), ('￣', '￣'),
  ('\u{102e0}', '\u{102e0}'), ('\u{10ae5}', '\u{10ae6}'),
  ('𐴢', '\u{10d27}'), ('\u{10f46}', '\u{10f50}'),
  ('\u{110b9}', '\u{110ba}'), ('\u{11133}', '\u{11134}'),
  ('\u{11173}', '\u{11173}'), ('𑇀', '𑇀'), ('\u{111ca}', '\u{111cc}'),
  ('𑈵', '\u{11236}'), ('\u{112e9}', '\u{112ea}'),
  ('\u{1133c}', '\u{1133c}'), ('𑍍', '𑍍'), ('\u{11366}', '\u{1136c}'),
  ('\u{11370}', '\u{11374}'), ('\u{11442}', '\u{11442}'),
  ('\u{11446}', '\u{11446}'), ('\u{114c2}', '\u{114c3}'),
  ('\u{115bf}', '\u{115c0}'), ('\u{1163f}', '\u{1163f}'),
  ('𑚶', '\u{116b7}'), ('\u{1172b}', '\u{1172b}'),
  ('\u{11839}', '\u{1183a}'), ('𑤽', '\u{1193e}'),
  ('\u{11943}', '\u{11943}'), ('\u{119e0}', '\u{119e0}'),
  ('\u{11a34}', '\u{11a34}'), ('\u{11a47}', '\u{11a47}'),
  ('\u{11a99}', '\u{11a99}'), ('\u{11c3f}', '\u{11c3f}'),
  ('\u{11d42}', '\u{11d42}'), ('\u{11d44}', '\u{11d45}'),
  ('\u{11d97}', '\u{11d97}'), ('\u{16af0}', '\u{16af4}'),
  ('\u{16b30}', '\u{16b36}'), ('\u{16f8f}', '𖾟'), ('𖿰', '𖿱'),
  ('\u{1d167}', '\u{1d169}'), ('𝅭', '\u{1d172}'),
...
pub const GRAPHEME_EXTEND: &'static [(char, char)] = &[
  ...
  ('\u{b55}', '\u{b57}'), ('\u{b62}', '\u{b63}'), ('\u{b82}', '\u{b82}'),
  ...
  ('\u{d57}', '\u{d57}'), ('\u{d62}', '\u{d63}'), ('\u{d81}', '\u{d81}'),
  ('\u{dca}', '\u{dca}'), ('\u{dcf}', '\u{dcf}'), ('\u{dd2}', '\u{dd4}'),
  ('\u{dd6}', '\u{dd6}'), ('\u{ddf}', '\u{ddf}'), ('\u{e31}', '\u{e31}'),
  ('\u{e34}', '\u{e3a}'), ('\u{e47}', '\u{e4e}'), ('\u{eb1}', '\u{eb1}'),
  ('\u{eb4}', '\u{ebc}'), ('\u{ec8}', '\u{ecd}'), ('\u{f18}', '\u{f19}'),
  ...
  ('\u{1a7f}', '\u{1a7f}'), ('\u{1ab0}', '\u{1ac0}'),
  ('\u{1b00}', '\u{1b03}'), ('\u{1b34}', '\u{1b3a}'),
  ('\u{1b3c}', '\u{1b3c}'), ('\u{1b42}', '\u{1b42}'),
  ('\u{1b6b}', '\u{1b73}'), ('\u{1b80}', '\u{1b81}'),
  ('\u{1ba2}', '\u{1ba5}'), ('\u{1ba8}', '\u{1ba9}'),
  ('\u{1bab}', '\u{1bad}'), ('\u{1be6}', '\u{1be6}'),
  ('\u{1be8}', '\u{1be9}'), ('\u{1bed}', '\u{1bed}'),
  ('\u{1bef}', '\u{1bf1}'), ('\u{1c2c}', '\u{1c33}'),
  ('\u{1c36}', '\u{1c37}'), ('\u{1cd0}', '\u{1cd2}'),
  ('\u{1cd4}', '\u{1ce0}'), ('\u{1ce2}', '\u{1ce8}'),
  ('\u{1ced}', '\u{1ced}'), ('\u{1cf4}', '\u{1cf4}'),
  ('\u{1cf8}', '\u{1cf9}'), ('\u{1dc0}', '\u{1df9}'),
  ('\u{1dfb}', '\u{1dff}'), ('\u{200c}', '\u{200c}'),
  ...
  ('\u{11930}', '\u{11930}'), ('\u{1193b}', '\u{1193c}'),
  ('\u{1193e}', '\u{1193e}'), ('\u{11943}', '\u{11943}'),
  ('\u{119d4}', '\u{119d7}'), ('\u{119da}', '\u{119db}'),
  ('\u{119e0}', '\u{119e0}'), ('\u{11a01}', '\u{11a0a}'),
  ('\u{11a33}', '\u{11a38}'), ('\u{11a3b}', '\u{11a3e}'),
  ...
  ('\u{16f8f}', '\u{16f92}'), ('\u{16fe4}', '\u{16fe4}'),
...
pub const GRAPHEME_LINK: &'static [(char, char)] = &[
  ...
  ('\u{a806}', '\u{a806}'), ('\u{a82c}', '\u{a82c}'),
  ('\u{a8c4}', '\u{a8c4}'), ('꥓', '꥓'), ('꧀', '꧀'),
  ('\u{aaf6}', '\u{aaf6}'), ('\u{abed}', '\u{abed}'),
...
pub const ID_CONTINUE: &'static [(char, char)] = &[
  ...
  ('ࢶ', 'ࣇ'), ('\u{8d3}', '\u{8e1}'), ('\u{8e3}', '\u{963}'),
  ('०', '९'), ('ॱ', 'ঃ'), ('অ', 'ঌ'), ('এ', 'ঐ'),
  ('ও', 'ন'), ('প', 'র'), ('ল', 'ল'), ('শ', 'হ'),
  ('\u{9bc}', '\u{9c4}'), ('ে', 'ৈ'), ('ো', 'ৎ'),
  ('\u{9d7}', '\u{9d7}'), ('ড়', 'ঢ়'), ('য়', '\u{9e3}'), ('০', 'ৱ'),
  ('ৼ', 'ৼ'), ('\u{9fe}', '\u{9fe}'), ('\u{a01}', 'ਃ'), ('ਅ', 'ਊ'),
  ('ਏ', 'ਐ'), ('ਓ', 'ਨ'), ('ਪ', 'ਰ'), ('ਲ', 'ਲ਼'),
  ('ਵ', 'ਸ਼'), ('ਸ', 'ਹ'), ('\u{a3c}', '\u{a3c}'), ('ਾ', '\u{a42}'),
  ('\u{a47}', '\u{a48}'), ('\u{a4b}', '\u{a4d}'), ('\u{a51}', '\u{a51}'),
  ('ਖ਼', 'ੜ'), ('ਫ਼', 'ਫ਼'), ('੦', '\u{a75}'), ('\u{a81}', 'ઃ'),
  ('અ', 'ઍ'), ('એ', 'ઑ'), ('ઓ', 'ન'), ('પ', 'ર'),
  ...
  ('ೱ', 'ೲ'), ('\u{d00}', 'ഌ'), ('എ', 'ഐ'), ('ഒ', '\u{d44}'),
  ('െ', 'ൈ'), ('ൊ', 'ൎ'), ('ൔ', '\u{d57}'), ('ൟ', '\u{d63}'),
  ('൦', '൯'), ('ൺ', 'ൿ'), ('\u{d81}', 'ඃ'), ('අ', 'ඖ'),
  ('ක', 'න'), ('ඳ', 'ර'), ('ල', 'ල'), ('ව', 'ෆ'),
  ('\u{dca}', '\u{dca}'), ('\u{dcf}', '\u{dd4}'), ('\u{dd6}', '\u{dd6}'),
  ('ෘ', '\u{ddf}'), ('෦', '෯'), ('ෲ', 'ෳ'), ('ก', '\u{e3a}'),
  ('เ', '\u{e4e}'), ('๐', '๙'), ('ກ', 'ຂ'), ('ຄ', 'ຄ'),
  ('ຆ', 'ຊ'), ('ຌ', 'ຣ'), ('ລ', 'ລ'), ('ວ', 'ຽ'),
  ('ເ', 'ໄ'), ('ໆ', 'ໆ'), ('\u{ec8}', '\u{ecd}'), ('໐', '໙'),
  ('ໜ', 'ໟ'), ('ༀ', 'ༀ'), ('\u{f18}', '\u{f19}'), ('༠', '༩'),
  ('\u{f35}', '\u{f35}'), ('\u{f37}', '\u{f37}'), ('\u{f39}', '\u{f39}'),
  ('༾', 'ཇ'), ('ཉ', 'ཬ'), ('\u{f71}', '\u{f84}'),
  ('\u{f86}', '\u{f97}'), ('\u{f99}', '\u{fbc}'), ('\u{fc6}', '\u{fc6}'),
  ('က', '၉'), ('ၐ', '\u{109d}'), ('Ⴀ', 'Ⴥ'), ('Ⴧ', 'Ⴧ'),
  ('Ⴭ', 'Ⴭ'), ('ა', 'ჺ'), ('ჼ', 'ቈ'), ('ቊ', 'ቍ'),
  ('ቐ', 'ቖ'), ('ቘ', 'ቘ'), ('ቚ', 'ቝ'), ('በ', 'ኈ'),
  ('ኊ', 'ኍ'), ('ነ', 'ኰ'), ('ኲ', 'ኵ'), ('ኸ', 'ኾ'),
  ('ዀ', 'ዀ'), ('ዂ', 'ዅ'), ('ወ', 'ዖ'), ('ዘ', 'ጐ'),
  ('ጒ', 'ጕ'), ('ጘ', 'ፚ'), ('\u{135d}', '\u{135f}'), ('፩', '፱'),
  ('ᎀ', 'ᎏ'), ('Ꭰ', 'Ᏽ'), ('ᏸ', 'ᏽ'), ('ᐁ', 'ᙬ'),
  ('ᙯ', 'ᙿ'), ('ᚁ', 'ᚚ'), ('ᚠ', 'ᛪ'), ('ᛮ', 'ᛸ'),
  ...
  ('\u{1a7f}', '᪉'), ('᪐', '᪙'), ('ᪧ', 'ᪧ'),
  ('\u{1ab0}', '\u{1abd}'), ('\u{1abf}', '\u{1ac0}'), ('\u{1b00}', 'ᭋ'),
  ('᭐', '᭙'), ('\u{1b6b}', '\u{1b73}'), ('\u{1b80}', '᯳'),
  ('ᰀ', '\u{1c37}'), ('᱀', '᱉'), ('ᱍ', 'ᱽ'), ('ᲀ', 'ᲈ'),
  ('Ა', 'Ჺ'), ('Ჽ', 'Ჿ'), ('\u{1cd0}', '\u{1cd2}'),
  ('\u{1cd4}', 'ᳺ'), ('ᴀ', '\u{1df9}'), ('\u{1dfb}', 'ἕ'),
  ('Ἐ', 'Ἕ'), ('ἠ', 'ὅ'), ('Ὀ', 'Ὅ'), ('ὐ', 'ὗ'),
  ('Ὑ', 'Ὑ'), ('Ὓ', 'Ὓ'), ('Ὕ', 'Ὕ'), ('Ὗ', 'ώ'),
  ('ᾀ', 'ᾴ'), ('ᾶ', 'ᾼ'), ('ι', 'ι'), ('ῂ', 'ῄ'),
  ('ῆ', 'ῌ'), ('ῐ', 'ΐ'), ('ῖ', 'Ί'), ('ῠ', 'Ῥ'),
  ('ῲ', 'ῴ'), ('ῶ', 'ῼ'), ('‿', '⁀'), ('⁔', '⁔'),
  ('ⁱ', 'ⁱ'), ('ⁿ', 'ⁿ'), ('ₐ', 'ₜ'), ('\u{20d0}', '\u{20dc}'),
  ('\u{20e1}', '\u{20e1}'), ('\u{20e5}', '\u{20f0}'), ('ℂ', 'ℂ'),
  ('ℇ', 'ℇ'), ('ℊ', 'ℓ'), ('ℕ', 'ℕ'), ('℘', 'ℝ'),
  ('ℤ', 'ℤ'), ('Ω', 'Ω'), ('ℨ', 'ℨ'), ('K', 'ℹ'),
  ('ℼ', 'ℿ'), ('ⅅ', 'ⅉ'), ('ⅎ', 'ⅎ'), ('Ⅰ', 'ↈ'),
  ('Ⰰ', 'Ⱞ'), ('ⰰ', 'ⱞ'), ('Ⱡ', 'ⳤ'), ('Ⳬ', 'ⳳ'),
  ('ⴀ', 'ⴥ'), ('ⴧ', 'ⴧ'), ('ⴭ', 'ⴭ'), ('ⴰ', 'ⵧ'),
  ('ⵯ', 'ⵯ'), ('\u{2d7f}', 'ⶖ'), ('ⶠ', 'ⶦ'), ('ⶨ', 'ⶮ'),
  ('ⶰ', 'ⶶ'), ('ⶸ', 'ⶾ'), ('ⷀ', 'ⷆ'), ('ⷈ', 'ⷎ'),
  ('ⷐ', 'ⷖ'), ('ⷘ', 'ⷞ'), ('\u{2de0}', '\u{2dff}'), ('々', '〇'),
  ('〡', '\u{302f}'), ('〱', '〵'), ('〸', '〼'), ('ぁ', 'ゖ'),
  ('\u{3099}', 'ゟ'), ('ァ', 'ヺ'), ('ー', 'ヿ'), ('ㄅ', 'ㄯ'),
  ('ㄱ', 'ㆎ'), ('ㆠ', 'ㆿ'), ('ㇰ', 'ㇿ'), ('㐀', '䶿'),
  ('一', '鿼'), ('ꀀ', 'ꒌ'), ('ꓐ', 'ꓽ'), ('ꔀ', 'ꘌ'),
  ('ꘐ', 'ꘫ'), ('Ꙁ', '\u{a66f}'), ('\u{a674}', '\u{a67d}'),
  ('ꙿ', '\u{a6f1}'), ('ꜗ', 'ꜟ'), ('Ꜣ', 'ꞈ'), ('Ꞌ', 'ꞿ'),
  ('Ꟃ', 'ꟊ'), ('Ꟶ', 'ꠧ'), ('\u{a82c}', '\u{a82c}'), ('ꡀ', 'ꡳ'),
  ...
  ('𐴰', '𐴹'), ('𐺀', '𐺩'), ('\u{10eab}', '\u{10eac}'),
  ('𐺰', '𐺱'), ('𐼀', '𐼜'), ('𐼧', '𐼧'), ('𐼰', '\u{10f50}'),
  ('𐾰', '𐿄'), ('𐿠', '𐿶'), ('𑀀', '\u{11046}'), ('𑁦', '𑁯'),
  ('\u{1107f}', '\u{110ba}'), ('𑃐', '𑃨'), ('𑃰', '𑃹'),
  ('\u{11100}', '\u{11134}'), ('𑄶', '𑄿'), ('𑅄', '𑅇'),
  ('𑅐', '\u{11173}'), ('𑅶', '𑅶'), ('\u{11180}', '𑇄'),
  ('\u{111c9}', '\u{111cc}'), ('𑇎', '𑇚'), ('𑇜', '𑇜'),
  ...
  ('\u{1145e}', '𑑡'), ('𑒀', '𑓅'), ('𑓇', '𑓇'), ('𑓐', '𑓙'),
  ('𑖀', '\u{115b5}'), ('𑖸', '\u{115c0}'), ('𑗘', '\u{115dd}'),
  ('𑘀', '\u{11640}'), ('𑙄', '𑙄'), ('𑙐', '𑙙'), ('𑚀', '𑚸'),
  ('𑛀', '𑛉'), ('𑜀', '𑜚'), ('\u{1171d}', '\u{1172b}'),
  ('𑜰', '𑜹'), ('𑠀', '\u{1183a}'), ('𑢠', '𑣩'), ('𑣿', '𑤆'),
  ('𑤉', '𑤉'), ('𑤌', '𑤓'), ('𑤕', '𑤖'), ('𑤘', '𑤵'),
  ('𑤷', '𑤸'), ('\u{1193b}', '\u{11943}'), ('𑥐', '𑥙'),
  ('𑦠', '𑦧'), ('𑦪', '\u{119d7}'), ('\u{119da}', '𑧡'),
  ('𑧣', '𑧤'), ('𑨀', '\u{11a3e}'), ('\u{11a47}', '\u{11a47}'),
  ('𑩐', '\u{11a99}'), ('𑪝', '𑪝'), ('𑫀', '𑫸'), ('𑰀', '𑰈'),
  ('𑰊', '\u{11c36}'), ('\u{11c38}', '𑱀'), ('𑱐', '𑱙'),
  ('𑱲', '𑲏'), ('\u{11c92}', '\u{11ca7}'), ('𑲩', '\u{11cb6}'),
  ('𑴀', '𑴆'), ('𑴈', '𑴉'), ('𑴋', '\u{11d36}'),
  ('\u{11d3a}', '\u{11d3a}'), ('\u{11d3c}', '\u{11d3d}'),
  ('\u{11d3f}', '\u{11d47}'), ('𑵐', '𑵙'), ('𑵠', '𑵥'),
  ('𑵧', '𑵨'), ('𑵪', '𑶎'), ('\u{11d90}', '\u{11d91}'),
  ('𑶓', '𑶘'), ('𑶠', '𑶩'), ('𑻠', '𑻶'), ('𑾰', '𑾰'),
  ('𒀀', '𒎙'), ('𒐀', '𒑮'), ('𒒀', '𒕃'), ('𓀀', '𓐮'),
  ('𔐀', '𔙆'), ('𖠀', '𖨸'), ('𖩀', '𖩞'), ('𖩠', '𖩩'),
  ('𖫐', '𖫭'), ('\u{16af0}', '\u{16af4}'), ('𖬀', '\u{16b36}'),
  ('𖭀', '𖭃'), ('𖭐', '𖭙'), ('𖭣', '𖭷'), ('𖭽', '𖮏'),
  ('𖹀', '𖹿'), ('𖼀', '𖽊'), ('\u{16f4f}', '𖾇'),
  ('\u{16f8f}', '𖾟'), ('𖿠', '𖿡'), ('𖿣', '\u{16fe4}'),
  ('𖿰', '𖿱'), ('𗀀', '𘟷'), ('𘠀', '𘳕'), ('𘴀', '𘴈'),
  ('𛀀', '𛄞'), ('𛅐', '𛅒'), ('𛅤', '𛅧'), ('𛅰', '𛋻'),
  ('𛰀', '𛱪'), ('𛱰', '𛱼'), ('𛲀', '𛲈'), ('𛲐', '𛲙'),
  ...
  ('\u{1e000}', '\u{1e006}'), ('\u{1e008}', '\u{1e018}'),
  ('\u{1e01b}', '\u{1e021}'), ('\u{1e023}', '\u{1e024}'),
  ('\u{1e026}', '\u{1e02a}'), ('𞄀', '𞄬'), ('\u{1e130}', '𞄽'),
  ('𞅀', '𞅉'), ('𞅎', '𞅎'), ('𞋀', '𞋹'), ('𞠀', '𞣄'),
  ('\u{1e8d0}', '\u{1e8d6}'), ('𞤀', '𞥋'), ('𞥐', '𞥙'),
  ('𞸀', '𞸃'), ('𞸅', '𞸟'), ('𞸡', '𞸢'), ('𞸤', '𞸤'),
  ('𞸧', '𞸧'), ('𞸩', '𞸲'), ('𞸴', '𞸷'), ('𞸹', '𞸹'),
  ('𞸻', '𞸻'), ('𞹂', '𞹂'), ('𞹇', '𞹇'), ('𞹉', '𞹉'),
  ('𞹋', '𞹋'), ('𞹍', '𞹏'), ('𞹑', '𞹒'), ('𞹔', '𞹔'),
...
pub const OTHER_ALPHABETIC: &'static [(char, char)] = &[
  ...
  ('\u{d3e}', '\u{d44}'), ('െ', 'ൈ'), ('ൊ', 'ൌ'),
  ('\u{d57}', '\u{d57}'), ('\u{d62}', '\u{d63}'), ('\u{d81}', 'ඃ'),
  ...
  ('ᩡ', '\u{1a74}'), ('\u{1abf}', '\u{1ac0}'), ('\u{1b00}', 'ᬄ'),
  ('\u{1b35}', 'ᭃ'), ('\u{1b80}', 'ᮂ'), ('ᮡ', '\u{1ba9}'),
  ('\u{1bac}', '\u{1bad}'), ('ᯧ', '\u{1bf1}'), ('ᰤ', '\u{1c36}'),
  ('\u{1de7}', '\u{1df4}'), ('Ⓐ', 'ⓩ'), ('\u{2de0}', '\u{2dff}'),
  ('\u{a674}', '\u{a67b}'), ('\u{a69e}', '\u{a69f}'),
  ('\u{a802}', '\u{a802}'), ('\u{a80b}', '\u{a80b}'), ('ꠣ', 'ꠧ'),
  ('ꢀ', 'ꢁ'), ('ꢴ', 'ꣃ'), ('\u{a8c5}', '\u{a8c5}'),
  ('\u{a8ff}', '\u{a8ff}'), ('\u{a926}', '\u{a92a}'), ('\u{a947}', 'ꥒ'),
  ('\u{a980}', 'ꦃ'), ('ꦴ', 'ꦿ'), ('\u{a9e5}', '\u{a9e5}'),
  ...
  ('\u{10d24}', '\u{10d27}'), ('\u{10eab}', '\u{10eac}'), ('𑀀', '𑀂'),
  ('\u{11038}', '\u{11045}'), ('𑂂', '𑂂'), ('𑂰', '𑂸'),
  ('\u{11100}', '\u{11102}'), ('\u{11127}', '\u{11132}'), ('𑅅', '𑅆'),
  ('\u{11180}', '𑆂'), ('𑆳', '𑆿'), ('𑇎', '\u{111cf}'),
  ('𑈬', '\u{11234}'), ('\u{11237}', '\u{11237}'),
  ...
  ('\u{1171d}', '\u{1172a}'), ('𑠬', '𑠸'), ('\u{11930}', '𑤵'),
  ('𑤷', '𑤸'), ('\u{1193b}', '\u{1193c}'), ('𑥀', '𑥀'),
  ('𑥂', '𑥂'), ('𑧑', '\u{119d7}'), ('\u{119da}', '𑧟'),
  ('𑧤', '𑧤'), ('\u{11a01}', '\u{11a0a}'), ('\u{11a35}', '𑨹'),
  ...
  ('\u{16f4f}', '\u{16f4f}'), ('𖽑', '𖾇'), ('\u{16f8f}', '\u{16f92}'),
  ('𖿰', '𖿱'), ('\u{1bc9e}', '\u{1bc9e}'), ('\u{1e000}', '\u{1e006}'),
...
pub const OTHER_GRAPHEME_EXTEND: &'static [(char, char)] = &[
  ...
  ('\u{1b35}', '\u{1b35}'), ('\u{200c}', '\u{200c}'),
  ('\u{302e}', '\u{302f}'), ('\u{ff9e}', '\u{ff9f}'),
  ('\u{1133e}', '\u{1133e}'), ('\u{11357}', '\u{11357}'),
  ('\u{114b0}', '\u{114b0}'), ('\u{114bd}', '\u{114bd}'),
  ('\u{115af}', '\u{115af}'), ('\u{11930}', '\u{11930}'),
...
pub const XID_CONTINUE: &'static [(char, char)] = &[
  ...
  ('Ꜣ', 'ꞈ'), ('Ꞌ', 'ꞿ'), ('Ꟃ', 'ꟊ'), ('Ꟶ', 'ꠧ'),
  ('\u{a82c}', '\u{a82c}'), ('ꡀ', 'ꡳ'), ('ꢀ', '\u{a8c5}'),
  ('꣐', '꣙'), ('\u{a8e0}', 'ꣷ'), ('ꣻ', 'ꣻ'), ('ꣽ', '\u{a92d}'),
  ('ꤰ', '꥓'), ('ꥠ', 'ꥼ'), ('\u{a980}', '꧀'), ('ꧏ', '꧙'),
  ('ꧠ', 'ꧾ'), ('ꨀ', '\u{aa36}'), ('ꩀ', 'ꩍ'), ('꩐', '꩙'),
  ('ꩠ', 'ꩶ'), ('ꩺ', 'ꫂ'), ('ꫛ', 'ꫝ'), ('ꫠ', 'ꫯ'),
  ('ꫲ', '\u{aaf6}'), ('ꬁ', 'ꬆ'), ('ꬉ', 'ꬎ'), ('ꬑ', 'ꬖ'),
  ('ꬠ', 'ꬦ'), ('ꬨ', 'ꬮ'), ('ꬰ', 'ꭚ'), ('ꭜ', 'ꭩ'),
  ('ꭰ', 'ꯪ'), ('꯬', '\u{abed}'), ('꯰', '꯹'), ('가', '힣'),
  ('ힰ', 'ퟆ'), ('ퟋ', 'ퟻ'), ('豈', '舘'), ('並', '龎'),
  ('ﬀ', 'ﬆ'), ('ﬓ', 'ﬗ'), ('יִ', 'ﬨ'), ('שׁ', 'זּ'),
  ('טּ', 'לּ'), ('מּ', 'מּ'), ('נּ', 'סּ'), ('ףּ', 'פּ'),
  ('צּ', 'ﮱ'), ('ﯓ', 'ﱝ'), ('ﱤ', 'ﴽ'), ('ﵐ', 'ﶏ'),
  ('ﶒ', 'ﷇ'), ('ﷰ', 'ﷹ'), ('\u{fe00}', '\u{fe0f}'),
  ...
  ('𐭠', '𐭲'), ('𐮀', '𐮑'), ('𐰀', '𐱈'), ('𐲀', '𐲲'),
  ('𐳀', '𐳲'), ('𐴀', '\u{10d27}'), ('𐴰', '𐴹'), ('𐺀', '𐺩'),
  ('\u{10eab}', '\u{10eac}'), ('𐺰', '𐺱'), ('𐼀', '𐼜'),
  ('𐼧', '𐼧'), ('𐼰', '\u{10f50}'), ('𐾰', '𐿄'), ('𐿠', '𐿶'),
  ('𑀀', '\u{11046}'), ('𑁦', '𑁯'), ('\u{1107f}', '\u{110ba}'),
  ('𑃐', '𑃨'), ('𑃰', '𑃹'), ('\u{11100}', '\u{11134}'),
  ('𑄶', '𑄿'), ('𑅄', '𑅇'), ('𑅐', '\u{11173}'), ('𑅶', '𑅶'),
  ('\u{11180}', '𑇄'), ('\u{111c9}', '\u{111cc}'), ('𑇎', '𑇚'),
  ('𑇜', '𑇜'), ('𑈀', '𑈑'), ('𑈓', '\u{11237}'),
  ('\u{1123e}', '\u{1123e}'), ('𑊀', '𑊆'), ('𑊈', '𑊈'),
